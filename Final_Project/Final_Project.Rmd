...
#plot_tree(full_tax, color = "Kingdom", size = "Structure", sizebase = 2, label.tips = "taxa_names")
#?plot_tree()
#phy_tree(full@tax_table)
```
HELP WITH PLOT_TREE
<br>
...
NEED TO MERGE SAMPLES BEFRE THIS WILL WORK, MERGE BY KINGDOM?
...
EXPLAIN ORDINATION HERE AND SAY WHAT I WANT TO USE IT FOR
